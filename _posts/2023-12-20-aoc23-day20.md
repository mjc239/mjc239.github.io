...
|:--:|
| Diagram visualizing the structure of the modules. The `FlipFlop`s are in blue, `Conjunction`s in orange, `Broadcaster` in pink, and the final output module `nx` is in yellow. | 
